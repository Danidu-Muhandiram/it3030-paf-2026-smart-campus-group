...
Vite + React + TypeScript scaffold located in `frontend/`. Run `npm install` then `npm run dev` to start the client on `http://localhost:5173`.
...
│   ├── auth/                # Auth flows, guards (placeholder)
│   ├── components/          # Shared UI components
│   ├── pages/               # Route-level screens (to be added later)
│   ├── routes/              # React Router config and loaders
│   ├── layout/              # App shells, nav, footers
│   ├── context/             # React context providers (theme, user, etc.)
│   ├── App.tsx              # Root component
│   └── main.tsx             # Entry point mounting React app
└── README.md                # Generated by Vite; optional to keep
```

Core frontend dependencies already installed:
